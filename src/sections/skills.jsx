...
const Contact = () => {
  ...
  const contactCards = [
    ...
    },
    {
      ...
      value: "https://www.linkedin.com/in/felipe-corredor-95664434b/",
  ...
  return (
    <section id="contact" className="relative py-24 px-6 overflow-hidden" style={{ background: "#0c0c10" }}>
      ...
      <div className="relative max-w-4xl mx-auto" style={{ zIndex: 1 }}>
        ...
        <div className="mb-16">
          ...
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(38px, 6vw, 60px)", fontWeight: 800, color: "#f0f0f5", letterSpacing: "-0.02em", lineHeight: 1.05, marginBottom: 16 }}>
            {tx.heading1}{" "}
          ...
          <div className="relative overflow-hidden"
            ...
            {sent ? (
              <div className="flex flex-col items-center justify-center text-center py-10 gap-3">
                ...
                <p style={{ fontFamily: "'Syne', sans-serif", fontSize: 18, fontWeight: 700, color: "#e0e0f0" }}>{tx.successTitle}</p>
                <p style={{ fontSize: 13, color: "#5a6a60" }}>{tx.successSub}</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div style={{ marginBottom: 8 }}>
                  <p style={{ fontFamily: "'Syne', sans-serif", fontSize: 17, fontWeight: 700, color: "#e8e8f0", marginBottom: 4 }}>{tx.formTitle}</p>
